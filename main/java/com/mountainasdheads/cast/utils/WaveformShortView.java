 ...
 */
public class WaveformShortView extends SurfaceView {
    ...
    public WaveformShortView(Context context) {
        this(context, null, 0);
    }

    public WaveformShortView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveformShortView(Context context, AttributeSet attrs, int defStyle) {
